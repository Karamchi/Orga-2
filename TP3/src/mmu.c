...
void mmu_inicializar_dir_kernel() {
	...
	for (i=0; i<4 ; i++){	
		pdep[i] = (page_dir_entry) { 	
			...
			(unsigned char)   0x01, //rw
			(unsigned char)   0x00, //us
			(unsigned char)   0x00, //pwt
			(unsigned char)   0x00, //pcd
			(unsigned char)   0x00, //a
			(unsigned char)   0x00, //z
			(unsigned char)   0x00, //ps
			(unsigned char)   0x00, //g
			(unsigned char)   0x00, //disp
		    (unsigned int)    0x28+i, //base
		};
	}
